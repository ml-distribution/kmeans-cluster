...
public class KMeansSimple {
	 ...
	 */
	void PointAllCtrs(final int nclusters, final double[] xi, final double[][] c, int[] ai, double[] ui, double[] li) {
	 ...
	 */
	void Initialize(final int nclusters, final double[][] table, final double[][] c, int[] q, double[][] cp,
			double[] u, double[] l, int[] a) {
	 ...
	 *  @return pointer to the clustered table object
	 */
	public Cluster[] findClusters(final double[][] object, int nclusters, int maxIterations, double tolerance) {
		// Input table object.
